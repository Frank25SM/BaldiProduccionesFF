...
import 'menu_principal_back_model.dart';
export 'menu_principal_back_model.dart';

class MenuPrincipalBackWidget extends StatefulWidget {
  const MenuPrincipalBackWidget({super.key});

  @override
  State<MenuPrincipalBackWidget> createState() =>
      _MenuPrincipalBackWidgetState();
}

class _MenuPrincipalBackWidgetState extends State<MenuPrincipalBackWidget>
    with TickerProviderStateMixin {
  late MenuPrincipalBackModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenuPrincipalBackModel());
