...
import 'conocenos_model.dart';
export 'conocenos_model.dart';

class ConocenosWidget extends StatefulWidget {
  const ConocenosWidget({super.key});

  @override
  State<ConocenosWidget> createState() => _ConocenosWidgetState();
}

class _ConocenosWidgetState extends State<ConocenosWidget> {
  late ConocenosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConocenosModel());
