...
import 'paquetes_model.dart';
export 'paquetes_model.dart';

class PaquetesWidget extends StatefulWidget {
  const PaquetesWidget({super.key});

  @override
  State<PaquetesWidget> createState() => _PaquetesWidgetState();
}

class _PaquetesWidgetState extends State<PaquetesWidget> {
  late PaquetesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaquetesModel());
