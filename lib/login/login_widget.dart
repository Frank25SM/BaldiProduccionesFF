                                ...
                                child: Column(
                                  children: [
                                    Align(
                                      ...
                                      child: TabBar(
                                        isScrollable: true,
                                        labelColor: const Color(0xFFFCFEFC),
                                        ...
                                        indicatorColor: const Color(0xFF993290),
                                        indicatorWeight: 3.0,
                                        tabs: const [
                                          Tab(
                                            text: 'Crear Cuenta',
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  24.0),
                                                      child: Text(
                                                        'Rellene la información a continuación para acceder a su cuenta.',
                                                        textAlign:
                                                            TextAlign.start,
                                                        style: FlutterFlowTheme
                                                                .of(context)
